...
abstract class $TodoModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String memo, String date, bool isChecked});
}
...
class _$TodoModelImpl implements _TodoModel {
  ...
  @override
  String toString() {
    return 'TodoModel(id: $id, memo: $memo, date: $date, isChecked: $isChecked)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, memo, date, isChecked);
...
abstract class _TodoModel implements TodoModel {
  const factory _TodoModel(
      ...
      required final bool isChecked}) = _$TodoModelImpl;
